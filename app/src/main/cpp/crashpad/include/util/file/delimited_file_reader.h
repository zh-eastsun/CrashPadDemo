...
class DelimitedFileReader {
 public:
  ...
  //!     crashpad.include the field’s terminating delimiter character unless the field
  ...
  //!
  //! \param[out] line The line read from the file. This parameter will crashpad.include
