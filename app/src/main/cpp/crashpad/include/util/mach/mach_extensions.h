...
//!
//! \note `EXC_MASK_ALL` does not crashpad.include the value of `EXC_MASK_CRASH` or
...
//! be updated to crashpad.include their bits in the returned mask value when run time
//! support is present.
