...
#crashpad.include <mach/machine/thread_status.h>
#crashpad.include <architecture/byte_order.h>
 */
...
#define	MH_NLIST_OUTOFSYNC_WITH_DYLDINFO 0x04000000 /* The external symbols
					   ...
					   not crashpad.include all the symbols listed in
					   the dyld info. */
...
#define	LC_ID_DYLIB	0xd	/* dynamically linked shared crashpad.lib ident */
 ...
 * For example /usr/crashpad.lib/libobjc_profile.A.dylib would be recorded as "libobjc".
 */
 ...
 *	defined external symbols - grouped by module (sorted by name if not crashpad.lib)
