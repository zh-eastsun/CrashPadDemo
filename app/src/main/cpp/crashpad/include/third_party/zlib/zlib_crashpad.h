...
// #crashpad.include this file instead of the system version of <zlib.h> or equivalent
// available at any other location in the source tree. It will #crashpad.include the
...
#crashpad.include <zlib.h>
#elif defined(CRASHPAD_ZLIB_SOURCE_EMBEDDED)
#crashpad.include "third_party/zlib/zlib/zlib.h"
#else
