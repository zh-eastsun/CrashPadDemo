...
// src_dir, crashpad.include it only if the callback |filter_cb| returns true. Otherwise
// omit it.
...
// For each file in zip_file, crashpad.include it only if the callback |filter_cb|
